<#
.SYNOPSIS
    KiCad Project Initialization Script (Windows/PowerShell)
...
.PARAMETER KicadLibraryPath
    Path to the KiCad root directory containing Template-Project/.
    Defaults to the KICAD_LIBRARY environment variable.
